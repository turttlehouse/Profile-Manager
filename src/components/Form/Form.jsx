...
import { validateEmail, validateImageType, validatePhone } from "../../utils/validation";
  ...
  return (
    ...
    <>
        ...
        <div className="relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
          ...
          <h4 className="block font-sans text-2xl font-semibold text-blue-gray-900">Form</h4>

          <p className="mt-1 block font-sans text-base font-normal  text-gray-700">
          ...
          <form onSubmit={handleSubmit(onSubmit)}  className="mt-2 mb-2 w-80 max-w-screen-lg sm:w-96">
            ...
            <div className="mb-4 flex flex-col gap-6">
                ...
                <input {...register('profilePicture',{validate:validateFileType})} type="file" accept="image/*" id="profile-picture"  />
                {errors.profilePicture && <p className="text-red-500">Only png files are allowed.</p>}
              {/* Name Field */}
